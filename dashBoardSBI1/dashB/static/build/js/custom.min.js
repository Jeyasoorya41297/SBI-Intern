...
//                 i = {
//                     datasets: [{
//                         data: [{{student.maths}}, 20, 140, 180, 100],
//                         backgroundColor: ["#455C73", "#9B59B6", "#BDC3C7", "#26B99A", "#3498DB"],
//                         label: "My dataset"
//                     }],
...
$.fn.popover.Constructor.prototype.leave = function(a) {
    ...
    init_sparklines(), init_sidebar(), init_wysiwyg(), init_InputMask(), init_JQVmap(), init_cropper(), init_knob(), init_IonRangeSlider(), init_ColorPicker(), init_TagsInput(), init_parsley(), init_daterangepicker(), init_daterangepicker_right(), init_daterangepicker_single_call(), init_daterangepicker_reservation(), init_SmartWizard(), init_EasyPieChart(), init_echarts(), init_skycons(), init_select2(), init_validator(), init_chart_doughnut(), init_gauge(), init_PNotify(), init_starrr(), init_calendar(), init_compose(), init_CustomNotification(), init_autosize(), init_autocomplete()
});